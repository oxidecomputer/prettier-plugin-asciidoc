...
// Inline macros (image, kbd, btn, menu, footnote, pass) are
// atomic units in reflow — they must not be broken across lines,
// and they must interact correctly with fill() line-breaking.
