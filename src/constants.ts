...
// A single newline character (`\n`). Used wherever a boundary falls on
// one: inside a delimited block, where the newline after the open
// delimiter and before the close delimiter is not part of the content,
// and at the end of a clipped passthrough, whose trailing newline
// belongs to the fragment rather than to the token
// ({@link passthroughTokenWidth}).
