 ...
 * against all of it, the default entry against its rows restricted
 * to the product it spells. Refreshing it is therefore how a
 * mechanism fix gets PINNED - the fixing commit shrinks the ledger
 * and says which family it emptied.
 *
